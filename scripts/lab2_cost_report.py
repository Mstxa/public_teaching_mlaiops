"""Reconcile the Lab 2 trial estimate with a Cloud Billing amount."""
...
def main() -> None:
    ...
    parser.add_argument("--actual-thb", type=float, required=True,
                        help="Observed THB in Cloud Billing for the Lab 2 scope")
    parser.add_argument("--billing-scope", default="project, Lab 2 usage period",
                        help="Filters/date range used in Cloud Billing")
    args = parser.parse_args()
    if args.actual_thb < 0:
